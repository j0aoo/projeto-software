 ...
 * @author cliente
 */
public class logFunc extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Login para secretario");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(logFunc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
