 ...
 * @author Usuario
 */
public class Excluiradmin extends javax.swing.JFrame {
    ...
    private void AtualizaCombo(){
        ...
        lista = sql.ListarComboAdmin();
        jcbNome.addItem("");
        
        for (Admin b : lista) {
            jcbNome.addItem(b.getLogin());
        }
    ...
    public void SelecionarCombo(){
        ...
        lista = sql.ConsultaCodigoAdmin(nome);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Excluiradmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
