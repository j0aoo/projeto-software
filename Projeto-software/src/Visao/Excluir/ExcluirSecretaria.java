 ...
 * @author Usuario
 */
public class ExcluirSecretaria extends javax.swing.JFrame {
    ...
    private void AtualizaCombo(){
        ...
        lista = sql.ListarComboSecretaria();
        jcbNome.addItem("");
        
        for (Secretaria b : lista) {
    ...
    public void SelecionarCombo(){
        ...
        lista = sql.ConsultaCodigoSecretaria(nome);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Excluir Secretaria");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExcluirSecretaria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
